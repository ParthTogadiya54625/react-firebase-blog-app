  ...
  const handleSubmit = async (e) => {
    ...
    if (!signUp) {
      if (email && password) {
        ...
        return toast.error("All fields are mendetory to fill!");
      }
    } else {
        ...
        <div className="row h-100 justify-content-center align-items-center">
          <div className='col-10 col-md-8 col-lg-6'>
            <form className="row" onSubmit={handleSubmit}>
              ...
              {signUp && (
                <div className="col-12 py-3">
                  <input type="password" className='form-control input-text-box' placeholder='Retype Password' name="confirmPassword" value={confirmPassword} onChange={handleChange} />
                </div>
              )}
            ...
            <div>
              {!signUp ? (
                <>
                  <div className="text-center justify-content-center mt-2 pt-2">
                    <p className="small fw-bold mt-2 pt-1 mb-0">
                      Don't have an account ? <span className='link-danger' style={{ textDecoration: "none", cursor: "pointer" }} onClick={() => setSignUp(true)}>Sign Up</span>
                    </p>
                  </div>
                </>
              ) : (
                <>
                  <div className="text-center justify-content-center mt-2 pt-2">
                    <p className="small fw-bold mt-2 pt-1 mb-0">
                      Already have an account ? <span className='link-danger' style={{ textDecoration: "none", cursor: "pointer", color: "#298af2" }} onClick={() => setSignUp(false)}>Sign In</span>
                    </p>
                  </div>
                </>
              )}
