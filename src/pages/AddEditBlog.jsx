...
const categoryOption = [
  "Fashion", "Techonology", "Food", "Politics", "Sports", "Business", "Culture", "Tourism"
];
    ...
    const uploadFile = () => {
      ...
      () => {
        getDownloadURL(uploadTask.snapshot.ref).then((downloadUrl) => {
          toast.info("Image uploaded to firebase store successfully!");
        ...
        <div className="row h-100 justify-content-center align-items-center">
          <div className="col-10 col-md-8 col-lg-6">
            <form className="row blog-form" onSubmit={handleSubmit}>
              ...
              <div className="col-12 py-3">
                <p className="trending">It is trending blog ?</p>
              ...
              <div className="col-12 py-3">
                <select value={category} className="catg-dropdown" onChange={onCategoryChange}>
